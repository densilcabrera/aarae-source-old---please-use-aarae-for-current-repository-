function [OUT, varargout] = Triangle_pulse(fs,T,edge,hifreq,lofreq,dispersion,wind,modF)
...
if ~isempty(param) || nargin ~= 0
    ...
    lof = lofreq/(0.5*fs);
    % call pulsegen
    audio=pulsegen(fs,T,edge,'triangle','window',wind,'modulation',modF,'low_pass',hif,'high_pass',lof,'dispersion',dispersion);
