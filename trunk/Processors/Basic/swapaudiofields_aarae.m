...
audiofields = [isfield(in,audiofieldnames{1}), isfield(in,audiofieldnames{2}), ...
    isfield(in,audiofieldnames{3}), isfield(in,audiofieldnames{4}), isfield(in,audiofieldnames{5}), ...
    isfield(in,audiofieldnames{6}), isfield(in,audiofieldnames{7}), isfield(in,audiofieldnames{8}), ...
    isfield(in,audiofieldnames{9}), isfield(in,audiofieldnames{10}), isfield(in,audiofieldnames{11}), ...
    isfield(in,audiofieldnames{12}), isfield(in,audiofieldnames{13}), isfield(in,audiofieldnames{14}), ...
    isfield(in,audiofieldnames{15}), isfield(in,audiofieldnames{16})];
...
elseif sum(audiofields) == 2
    ...
    param = inputdlg(audiofieldnames,...
        ...
        [1 60],...
        cellstr(num2str(circshift((1:sum(audiofields))',1)))); % And the preset answers for your dialog.
