function out = thiroct_band_level_barplot(in, fs, cal)
...
fhi = 20000; % default highest centre frequency
flo = 25; % default lowest centre frequency
showpercentiles = 1;
...
if bands > 1
    ...
    [audiooct, frequencies] = thirdoctbandfilter(audio,fs,flist);
